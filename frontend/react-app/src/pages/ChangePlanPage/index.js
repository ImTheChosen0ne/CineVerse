            ...
            <div className="account-container">
                <div className="account-center">
                    ...
                    <div className="btn-bar btn-bar-center">
                        <button className="btn btn-gray btn-small" onClick={() => history.push("/account")}>Back</button>
                        <OpenModalButton
                            buttonText="Continue"
                        ...
                        {/*<button className="btn btn-blue btn-small" disabled={sessionUser.plan === selectedPlan} onClick={() => {}}>Continue</button>*/}
                    </div>
                </div>
            </div>
