    ...
    return (
        <div className="info">
            ...
            <div className="info-text">
                <div>
                    <p className="info-title">The CineVerse you love for just $6.99.</p>
                    <p className="info-description">Get the Standard with ads plan.</p>
                </div>
                <div>
                    <NavLink exact to="/signup">Learn More
