...
public class DatabaseSeeder {
    ...
    @Bean
    CommandLineRunner run(RoleRepository roleRepository, UserRepository userRepository, MovieRepository movieRepository, ProfileRepository profileRepository, ProfileRatingRepository profileRatingRepository, MovieRatingRepository movieRatingRepository, PasswordEncoder passwordEncoder) {
        return args -> {
...
//            MovieRating movieRating = new MovieRating(1, "like", "1/9/2024");
//            MovieRating savedMovieRating = movieRatingRepository.save(movieRating);
//            movieRatings.add(savedMovieRating);

//            MovieRating movieRating2 = new MovieRating(2, "like", "1/9/2024");
...
//            Rating rating = new Rating(1, "like", "1/9/2024", movie);
//            Rating savedRating = ratingRepository.save(rating);

            Set<ProfileRating> movieProfileProfileRatings = new HashSet<>();
//            movieProfileRatings.add(savedRating);

            Profile profile = new Profile(1, "demo", "https://occ-0-616-621.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABbGa4GvjA3sdbhrXZi7RG0-nuSXUxt-IZoVxB_7lHtMKT-wQ-CsDeukenQ6z6x4iUdqx4NJR4Sr3RDraWK1uYyKWRapH8T-tnFtb.png?r=59d", watchLater, movieProfileProfileRatings);
            Profile profiles = profileRepository.save(profile);

            Profile profile2 = new Profile(2, "demo2", "https://occ-0-616-621.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABbGa4GvjA3sdbhrXZi7RG0-nuSXUxt-IZoVxB_7lHtMKT-wQ-CsDeukenQ6z6x4iUdqx4NJR4Sr3RDraWK1uYyKWRapH8T-tnFtb.png?r=59d", watchLater, movieProfileProfileRatings);
